...
Would you like me to also draft the **`README.md` skeleton** (install, run, test instructions) so the candidate has a clear starting point, or do you want to leave that entirely up to them?
